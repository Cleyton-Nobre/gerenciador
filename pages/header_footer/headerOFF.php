            ...
            <header class='container-fluid bg-dark'>
                <nav class='navbar p-3'>
                    ...
                    <ul class='nav mr-auto ml-5 text-white mt-2'>             
                        ...
                        <li class='nav-item'><a class='nav-link text-white border btn btn-dark mr-3' href="<?=URL_USUARIO;?>cadastro"><i class="fas fa-user-plus"></i> Cadastro</a></li>
                        <li class='nav-item'><a class='nav-link text-white border btn btn-dark' href="<?=URL_USUARIO;?>login"><i class="fas fa-user-check"></i> Login</a></li>
                    </ul>
                </nav>
            </header>
